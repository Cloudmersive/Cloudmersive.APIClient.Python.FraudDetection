...
(Get-Content ./setup.py).replace('Use the Content Disarm and Reconstruction API to remove security risks from documents by tearing them down, removing unsafe content and rebuilding them.  # noqa: E501', '') | Set-Content ./setup.py
