...
import cloudmersive_fraud_detection_api_client.models
from cloudmersive_fraud_detection_api_client import rest
    ...
    def __deserialize(self, data, klass):
        ...
        if type(klass) == str:
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(cloudmersive_fraud_detection_api_client.models, klass)
